...
glodap_file = os.path.join(os.getenv('OS_DATA'), 'GLODAP', "GLODAPv2.2022_Merged_Master_File.mat")

data = loadmat(glodap_file)
...
# Set the PATH relative to the package
...
EstimatesLIR, UncertaintiesLIR, CoefficientsLIR = PyESPER_LIR(
    ['pH'], pyESPER_path, OutputCoordinates, PredictorMeasurements, EstDates=EstDates, Equations=[1])
